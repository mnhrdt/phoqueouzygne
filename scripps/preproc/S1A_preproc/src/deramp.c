/*******************************************************************************
 * Routine to deramp Sentinal TOPS data prior to running xcorr                 *
 * The algorithm comes from:                                                   *
 * https://sentinel.esa.int/documents/247904/1653442/Sentinel-1-TOPS-SLC_Deramping *
 *******************************************************************************/
/********************************************************************************
 * Creator:  David T. Sandwell and Xiohua Xu                                    *
...
void deramp(double *x, double *y, double *z, int nmax, int nval, double xp, double *yp, int *ir)
{
/*
