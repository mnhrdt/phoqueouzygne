/************************************************************************
* rng_ref computes the range reference function used for range 		*
* 	compression of raw radar echoes					*
************************************************************************/
/************************************************************************
...
/* Compute range reference function */
  ...
  /* Compute number of points in reference function. */
	...
	k1start = fabs(pctbw)*npts;
	k1end = npts - fabs(pctbw)*npts;
