...
#    awk '{print 1992+$1/365.25,$2,7,-45,$5,$6,$7}' < table.gmt > text
  ...
  set region = `minmax text -C | awk '{print $1-0.5, $2+0.5, $3-500, $4+500}'`
#  set region = `minmax text -C | awk '{print $1-0.5, $2+0.5, -1200, 1200}'`
  pstext text -JX8.8i/6.8i -R$region[1]/$region[2]/$region[3]/$region[4] -D0.2/0.2 -X1.5i -Y1i -K -N > stacktable_all.ps 
  awk '{print $1,$2}' < text > text2
  psxy text2 -Sp0.1 -G0 -R -JX -Ba1:"year":/a1000g00f1000:"baseline (m)":WSen -O >> stacktable_all.ps 
