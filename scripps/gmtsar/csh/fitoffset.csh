...
#   use trend2d
#
 ( trend2d r.xyz -Fxyz -N1r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > rm.coef
 ( trend2d a.xyz -Fxyz -N1r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > am.coef
#
#  get the data range and paste to the coeffifients
#
 minmax r.xyz -C | awk '{print $1, $2, $3, $4 }' > range.coef
...
#   use trend2d
#
 ( trend2d r.xyz -Fxyz -N2r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > rm.coef
 ( trend2d a.xyz -Fxyz -N1r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > am.coef
#
#  get the data range and paste to the coeffifients
#
...
#
 ( trend2d r.xyz -Fxyz -N2r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > rm.coef
 ( trend2d a.xyz -Fxyz -N2r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > am.coef
#
#  get the data range and paste to the coeffifients
#
 minmax r.xyz -C | awk '{print $1, $2, $3, $4 }' > range.coef
...
#
 ( trend2d r.xyz -Fxyz -N2r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > rm.coef
 ( trend2d a.xyz -Fxyz -N3r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > am.coef
#
#  get the data range and paste to the coeffifients
#
 minmax r.xyz -C | awk '{print $1, $2, $3, $4 }' > range.coef
...
#   use trend2d
#
 ( trend2d r.xyz -Fxyz -N3r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > rm.coef
 ( trend2d a.xyz -Fxyz -N3r -V >  /dev/null ) |& grep oefficients | awk -F":" '{print $NF'} > am.coef
#
#  get the data range and paste to the coeffifients
#
