...
#
  ...
  grdsample $2 -Gtmp_topo.grd `grdinfo $1 -I-` `grdinfo $1 -I` -F
  
  grdmath $1 0 MUL 1 ADD tmp_topo.grd MUL = tmp_topo.grd
  
  grd2xyz $1 > tmp.xyz

  grd2xyz tmp_topo.grd > tmp_topo.xyz

  blockmedian tmp.xyz `grdinfo $1 -I-` $3 -V > tmp_b.xyz

  blockmedian tmp_topo.xyz `grdinfo $1 -I-` $3 -V > tmp_topo_b.xyz
